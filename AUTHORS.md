...
Ownership is verified mechanically where it is publicly legible: a claim
whose author owns the source repository, or is a public member of the
owning organization, merges automatically once validation passes
([camp-index#210](https://github.com/camp-registry/camp-index/issues/210));
anything less legible, an admin checks by hand. Schema validation enforces
...
CI independently rebuilds and verifies from the public tag, then
merges automatically as a registry act
([camp-index#66](https://github.com/camp-registry/camp-index/issues/66),
[#210](https://github.com/camp-registry/camp-index/issues/210)).
